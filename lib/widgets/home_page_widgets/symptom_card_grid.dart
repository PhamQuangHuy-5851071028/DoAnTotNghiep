  ...
  final List<Map<String, String>> symptoms = const [
    {
      "symptom": "Sốt",
      "desc":
      "Nhiệt độ cao hơn bình thường.\nThông thường khoảng 98,6 ° F (37 ° C)",
      "imgPath": "assets/symptoms/high_fever.png",
    },
    {
      "symptom": "Đau họng",
      "desc":
      "Đau họng là cảm giác đau, khô hoặc ngứa trong cổ họng.",
    ...
    },
    {
      "symptom": "Mệt mỏi",
      "desc":
      "Bạn không có năng lượng, không có động lực và cảm giác mệt mỏi.",
    ...
    {
      "symptom": "Khó thở",
      "desc": "Bạn cảm thấy khó thở và cảm giác tức ngực.",
      "imgPath": "assets/symptoms/sore_throat.png",
    },
  ];
